...
#   AMP   #
###########
#buildData.builtDatasetGlobal(p_list_ligand = "/home/buhan/Desktop/myproject/resultLigandInPDB" , ligand_ID = "AMP", thresold_RX = thresold_RX, thresold_blast = thresold_blast, verbose = 1)
...
#   ADP   #
###########
#buildData.builtDatasetGlobal(p_list_ligand = "/home/buhan/Desktop/myproject/resultLigandInPDB" , ligand_ID = "ADP", thresold_RX = thresold_RX, thresold_blast = thresold_blast, verbose = 1)
...
#buildData.builtDatasetGlobal(p_list_ligand = "/home/buhan/Desktop/myproject/resultLigandInPDB" , ligand_ID = "POP", thresold_RX = thresold_RX, thresold_blast = thresold_blast, verbose = 1)
...
#   ATP   #
###########
#buildData.builtDatasetGlobal(p_list_ligand = "/home/buhan/Desktop/myproject/resultLigandInPDB" , ligand_ID = "ATP", thresold_RX = thresold_RX, thresold_blast = thresold_blast, verbose = 1)
...
#buildData.builtDatasetGlobal(p_list_ligand = "/home/buhan/Desktop/myproject/resultLigandInPDB" , ligand_ID = "U5P",thresold_RX = thresold_RX, thresold_blast = thresold_blast, verbose = 1)
#datasetPreparation ("U5P")
#applyTMAlign ("U5P")
#ionIdentification ("U5P")
#print("0")
#retrieveSubstructSuperimposed ("U5P", thresold_BS = thresold_BS, thresold_superimposed_ribose = thresold_superimposed_ribose, thresold_superimposed_pi = thresold_superimposed_pi, thresold_shaep = thresold_shaep)
#print("1")
#analysisBS ("U5P")
#print("2")
#analysisSmile ("U5P")
...
#buildData.builtDatasetGlobal(p_list_ligand = "/home/buhan/Desktop/myproject/resultLigandInPDB" , ligand_ID = "UDP", thresold_RX = thresold_RX, thresold_blast = thresold_blast, verbose = 1)
#datasetPreparation ("UDP")
#applyTMAlign ("UDP")
#ionIdentification ("UDP")
#retrieveSubstructSuperimposed ("UDP", thresold_BS = thresold_BS, thresold_superimposed_ribose = thresold_superimposed_ribose, thresold_superimposed_pi = thresold_superimposed_pi, thresold_shaep = thresold_shaep)
#analysisBS ("UDP")
#analysisSmile ("UDP")
...
#buildData.builtDatasetGlobal(p_list_ligand = "/home/buhan/Desktop/myproject/resultLigandInPDB" , ligand_ID = "UTP", thresold_RX = thresold_RX, thresold_blast = thresold_blast, verbose = 1)
#datasetPreparation ("UTP")
#applyTMAlign ("UTP")
#ionIdentification ("UTP")
#retrieveSubstructSuperimposed ("UTP", thresold_BS = thresold_BS, thresold_superimposed_ribose = thresold_superimposed_ribose, thresold_superimposed_pi = thresold_superimposed_pi, thresold_shaep = thresold_shaep)
#analysisBS ("UTP")
#analysisSmile ("UTP")
...
#
'''
buildData.builtDatasetGlobal(p_list_ligand = "/home/buhan/Desktop/myproject/resultLigandInPDB" , ligand_ID = "C5P", thresold_RX = thresold_RX, thresold_blast = thresold_blast, verbose = 1)
datasetPreparation ("C5P")
applyTMAlign ("C5P")
ionIdentification ("C5P")
retrieveSubstructSuperimposed ("C5P", thresold_BS = thresold_BS, thresold_superimposed_ribose = thresold_superimposed_ribose, thresold_superimposed_pi = thresold_superimposed_pi, thresold_shaep = thresold_shaep)
analysisBS ("C5P")
analysisSmile ("C5P")
'''
##########
...
#
'''
buildData.builtDatasetGlobal(p_list_ligand = "/home/buhan/Desktop/myproject/resultLigandInPDB" , ligand_ID = "CDP", thresold_RX = thresold_RX, thresold_blast = thresold_blast, verbose = 1)
datasetPreparation ("CDP")
applyTMAlign ("CDP")
ionIdentification ("CDP")
retrieveSubstructSuperimposed ("CDP", thresold_BS = thresold_BS, thresold_superimposed_ribose = thresold_superimposed_ribose, thresold_superimposed_pi = thresold_superimposed_pi, thresold_shaep = thresold_shaep)
analysisBS ("CDP")
analysisSmile ("CDP")
'''
...
#
'''
buildData.builtDatasetGlobal(p_list_ligand = "/home/buhan/Desktop/myproject/resultLigandInPDB" , ligand_ID = "CTP", thresold_RX = thresold_RX, thresold_blast = thresold_blast, verbose = 1)
datasetPreparation ("CTP")
applyTMAlign ("CTP")
ionIdentification ("CTP")
retrieveSubstructSuperimposed ("CTP", thresold_BS = thresold_BS, thresold_superimposed_ribose = thresold_superimposed_ribose, thresold_superimposed_pi = thresold_superimposed_pi, thresold_shaep = thresold_shaep)
analysisBS ("CTP")
analysisSmile ("CTP")
'''
##########
...
#
'''
buildData.builtDatasetGlobal(p_list_ligand = "/home/buhan/Desktop/myproject/resultLigandInPDB" , ligand_ID = "5GP", thresold_RX = thresold_RX, thresold_blast = thresold_blast, verbose = 1)
datasetPreparation ("5GP")
applyTMAlign ("5GP")
ionIdentification ("5GP")
retrieveSubstructSuperimposed ("5GP", thresold_BS = thresold_BS, thresold_superimposed_ribose = thresold_superimposed_ribose, thresold_superimposed_pi = thresold_superimposed_pi, thresold_shaep = thresold_shaep)
analysisBS ("5GP")
analysisSmile ("5GP")
'''
##########
...
#
'''
buildData.builtDatasetGlobal(p_list_ligand = "/home/buhan/Desktop/myproject/resultLigandInPDB" , ligand_ID = "GDP", thresold_RX = thresold_RX, thresold_blast = thresold_blast, verbose = 1)
datasetPreparation ("GDP")
applyTMAlign ("GDP")
ionIdentification ("GDP")
retrieveSubstructSuperimposed ("GDP", thresold_BS = thresold_BS, thresold_superimposed_ribose = thresold_superimposed_ribose, thresold_superimposed_pi = thresold_superimposed_pi, thresold_shaep = thresold_shaep)
analysisBS ("GDP")
analysisSmile ("GDP")
'''
##########
...
#
'''
buildData.builtDatasetGlobal(p_list_ligand = "/home/buhan/Desktop/myproject/resultLigandInPDB" , ligand_ID = "GTP", thresold_RX = thresold_RX, thresold_blast = thresold_blast, verbose = 1)
datasetPreparation ("GTP")
applyTMAlign ("GTP")
ionIdentification ("GTP")
retrieveSubstructSuperimposed ("GTP", thresold_BS = thresold_BS, thresold_superimposed_ribose = thresold_superimposed_ribose, thresold_superimposed_pi = thresold_superimposed_pi, thresold_shaep = thresold_shaep)
analysisBS ("GTP")
analysisSmile ("GTP")
'''
...
#refClassification.classifRefProtein (prdataset, ["AMP"])
#arrangeResult.controlResult (["AMP", "ADP", "ATP","POP","U5P","UDP","UTP","C5P","CDP","CTP","5GP","GDP","GTP"])
#refClassification.classifRefProtein (prdataset, ["AMP", "ADP", "ATP","POP","U5P","UDP","UTP","C5P","CDP","CTP","5GP","GDP","GTP"])
...
#manageResult (["AMP"], name_folder_final, l_ligand_out)
#manageResult (["AMP", "ADP", "ATP","POP","U5P","UDP","UTP","C5P","CDP","CTP","5GP","GDP","GTP"], name_folder_final, l_ligand_out)
print("p1")
#arrangeResult.qualityExtraction (["AMP"], name_folder_final, p_list_ligand = "/home/buhan/Desktop/myproject/resultLigandInPDB", thresold_sheap = thresold_shaep)
#arrangeResult.qualityExtraction (["AMP", "ADP", "ATP","POP","U5P","UDP","UTP","C5P","CDP","CTP","5GP","GDP","GTP"], name_folder_final, p_list_ligand = "/home/buhan/Desktop/myproject/resultLigandInPDB", thresold_sheap = thresold_shaep)
print("p2")
...
# folder final
'''change'''
#pr_classif = pathManage.result("final_" + name_folder_final) + "Pi"#"Pi_LSR"
...
# analyse enantiomer
# bugc =l
#arrangeResult.enantiomer(["AMP", "ADP", "ATP","U5P","UDP","UTP","C5P","CDP","CTP","5GP","GDP","GTP"], name_folder_final)
#arrangeResult.enantiomer(["AMP", "ADP", "ATP","POP","U5P","UDP","UTP","C5P","CDP","CTP","5GP","GDP","GTP"], name_folder_final)
#analyse the superimposition of ligand references
#arrangeResult.superpositionAllRef(["AMP", "ADP", "POP", "ATP","U5P","UDP","UTP","C5P","CDP","CTP","5GP","GDP","GTP"], name_folder_final)
